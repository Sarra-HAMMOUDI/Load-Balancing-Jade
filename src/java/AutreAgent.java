...
public class AutreAgent extends Agent {
	...
	protected void setup()
	{
		...
		System.out.println("Bonjour , je suis "+ this.getAID().getLocalName() +"  je suis localisé dans le conteneur 4 -- AutreContainer");
		...
		addBehaviour(new CyclicBehaviour(){
			...
			public void action() {
	             ...
	             repleyPrincipal.setContent("La liste des requets AUTRE  est bien recu . Merci, Mr "+ msgFromPrincipalAgent.getSender().getName() );
